...
class GridContainer extends Component {
    ...
    render() {
        return (
            <div>
                <TrackGrid tracks={this.state.currentTracks} lives={this.state.lives} correctTrack={this.state.correctTrack} onSelectTrack={this.onSelectTrack} nextButtonPressed={this.getNextScreen}/>
